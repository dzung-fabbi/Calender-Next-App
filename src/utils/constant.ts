...
export const LABEL_WORK = [
  {
    label: 'Cúng giường',
    value: 1,
    work: ['Cầu phúc cầu tự', 'Cúng tế'],
  },
  {
    label: 'Hỷ sự',
    value: 2,
    work: ['Đính hôn', 'Ăn hỏi', 'Cưới gả'],
  },
  {
    label: 'Sửa nhà , tu tạo mộ phần',
    value: 3,
    work: [
      'Tu tạo động thổ',
      'Sửa kho',
